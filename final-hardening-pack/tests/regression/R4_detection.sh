...
BEFORE_COUNT=$(ssh -i /home/kali/.ssh/id_td5 OCC1@10.10.20.50 "grep -c '9000001' /var/log/suricata/fast.log 2>/dev/null" || echo 0)
...
AFTER_COUNT=$(ssh -i ~/.ssh/id_td5 OCC1@10.10.20.50 "grep -c '9000001' /var/log/suricata/fast.log 2>/dev/null" || echo 0)
